...
const Links = ({ drawer, setIsOpenDrawer, isOpenDrawer }) => {
    ...
    const pageLink = [new LinkClass(0, 'Home'), new LinkClass(1, 'Products')];
    const componentsLink = [new LinkClass('services', 'Layanan Kami')]
