...
module.exports = {
    ...
    rajaOngkir: {
        key: envVar.RAJAONGKIR_KEY,
    },
    tripay: {
        apiKey: envVar.TRIPAY_API_KEY,
        privateKey: envVar.TRIPAY_PRIVATE_KEY,
        merchantCode: envVar.TRIPAY_MERCHANT_CODE,
        url: envVar.TRIPAY_API_URL,
    }
};
