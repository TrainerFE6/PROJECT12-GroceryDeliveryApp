                            ...
                            <div className={`${isDownloadApp ? 'xl:space-y-6 space-y-4' : 'md:space-y-2.5 sm:space-y-1.5  space-y-2.5'} w-11/12`}>
                                {isDownloadApp ?
                                    <h1 className='pb-0 xl:text-3xl md:text-2xl text-xl font-bold capitalize xl:tracking-wide'>
                                        Unduh Aplikasi Mobile Kami <br /> dan Hemat Waktu, Uang
                                    </h1>
                                    : <h1 className='pb-0 md:text-2xl text-xl font-semibold capitalize xl:tracking-wide'>
                                        {isOurQuality ?
                                            'Kualitas Terbaik untuk Bahan Makanan Sehat dan Segar'
                                            : isService ?
                                                'Mengapa Kami adalah Toko Bahan Makanan Terbaik'
                                                : ''}
                                    </h1>}
                                <p className='lg:text-base text-gray-7o 00 md:text-sm sm:text-xs text-sm'>
                                    {isOurQuality ? 'Kami mengutamakan kualitas dalam setiap produk grocery kami, berikut adalah keunggulan produk kami. Makanan organik adalah makanan yang diproduksi.' : isService ? 'Kami menawarkan berbagai macam produk untuk dipilih, Anda dapat menemukan semua yang Anda butuhkan untuk memberi makan keluarga Anda.' : 'Aplikasi mobile grocery kami memudahkan Anda berbelanja kebutuhan sehari-hari. Anda dapat menjelajahi pilihan produk kami, membuat daftar belanja, dan memesan barang untuk diambil atau diantar.'}
                                </p>
                            </div>
