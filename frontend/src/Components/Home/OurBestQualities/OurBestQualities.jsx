...
export const ourBestQualityContext = React.createContext();
    ...
    return (
        <div className='lg:space-y-6 sm:space-y-4 space-y-5'>
            ...
            <ul className='md:space-y-4 sm:space-y-2 space-y-2.5'>
                {['Bahan Makanan Sehat dan Segar Berkualitas Terbaik', '100% Produk Organik & Alami', '100% Pengembalian & Pengembalian Dana'].map((quality, i) => (
