...
const SignUp: React.FC = () => {
  ...
  const onSubmit = async (data: FormCustomer) => {
    try {
      await instance.post('/auth-customers/register', data);
      toast.success('Registrasi Telah Berhasil');
      reset();
      navigate('/login?message=Registrasi%20Telah%20Berhasil');
    } catch (error) {
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              Grocery Delivery App adalah aplikasi yang memudahkan Anda untuk memesan dan menerima bahan makanan segar dan barang-barang kebutuhan sehari-hari langsung ke pintu rumah Anda.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Grocery Delivery App</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Daftar ke dalam Grocery
              </h2>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      type="password"
                      placeholder="Enter your kata sandi"
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
